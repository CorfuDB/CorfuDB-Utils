...
*/
                    ...
                    try {
                        ...
                        while (true) {
                            //try {
                            log.info("Actually....NOT Syncing inner streams to outer stream entry. sync not supported at present.");

                    /* cjr: sync no longer supported?
                     ...
                     */
                        ...
                        log.info("Finished (NOT) syncing inner streams.");
